...
<?php if (idUtilizadorNumerico()): ?>
        ...
        <div id="main-content">
            ...
            <div class="stats-grid" id="stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));">
                <a href="tickets_lista.php?filtro=abertos" class="stat-card" style="border-top: 3px solid var(--accent); text-decoration:none; color:inherit; display:block;">
                    <span class="label">Abertos</span>
                    <span class="value" id="stat-abertos"><?php echo $total_ativos; ?></span>
                </a>
                <a href="tickets_lista.php?filtro=progresso" class="stat-card" style="border-top: 3px solid var(--amber); text-decoration:none; color:inherit; display:block;">
                    <span class="label">Em Progresso</span>
                    <span class="value" id="stat-progresso"><?php echo $total_progresso; ?></span>
                </a>
                <a href="tickets_lista.php?filtro=resolvidos" class="stat-card" style="border-top: 3px solid var(--green); text-decoration:none; color:inherit; display:block;">
                    <span class="label">Resolvidos</span>
                    <span class="value" id="stat-resolvidos"><?php echo $total_resolvidos; ?></span>
                </a>
                <?php if ($verMetricasTecnicas): ?>
                <a href="tickets_lista.php?filtro=sla_risco" class="stat-card" style="border-top: 3px solid var(--amber); text-decoration:none; color:inherit; display:block;">
                    <span class="label">SLA em Risco</span>
                    <span class="value" id="stat-sla-risco" style="color: var(--amber);"><?php echo $sla_risco; ?></span>
                </a>
                <a href="tickets_lista.php?filtro=sla_vencido" class="stat-card" style="border-top: 3px solid var(--red); text-decoration:none; color:inherit; display:block;">
