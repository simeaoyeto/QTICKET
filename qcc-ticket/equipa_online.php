    ...
    <div class="app-layout">
        ...
        <div id="main-content">
            <div class="page-header">
                ...
                <p>Veja que técnicos e responsáveis das equipas de <strong>Redes & Sistemas</strong> e <strong>Desenvolvimento</strong> estão online para dar tratamento aos tickets.</p>
            </div>
                ...
                ?>
                    <div style="margin-bottom: 24px;">
                        <h3 style="font-size: 14px; color: var(--accent); margin-bottom: 10px; padding-bottom: 6px; border-bottom: 1px solid var(--border);">
                            🛠️ <?php echo htmlspecialchars($grupo['nome']); ?>
                        ...
                        <?php if (empty($grupo['membros'])): ?>
                            <p style="font-size: 13px; color: var(--text-muted); font-style: italic; padding-left: 4px;">Sem técnicos ou responsáveis registados nesta equipa.</p>
                        <?php else: ?>
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 12px 14px; background: var(--bg-input); border-radius: var(--radius-sm); border: 1px solid var(--border);">
                                        <div style="display: flex; align-items: center; gap: 10px; min-width: 0;">
                                            ...
                                            <div style="min-width:0;">
                                                ...
                                                <div style="font-size: 11px; color: var(--text-muted);"><?php echo htmlspecialchars($membro['perfil']); ?></div>
                                            </div>
                                        </div>
